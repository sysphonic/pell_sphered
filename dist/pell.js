...
var init = function init(settings) {
  ...
  content.oninput = function (_ref) {
    ...
    if (firstChild && firstChild.nodeType === 3) {
      exec(formatBlock, "<" + defaultParagraphSeparator + ">", true);
  ...
  var copyright = createElement("a");
  copyright.className = classes.copyright;
  copyright.target = "pell";
  copyright.href = "https://github.com/sysphonic/pell_sphered";
  copyright.title = "pell: Copyright (c) Jared Reich";
  copyright.innerHTML = "(c)"
  appendChild(actionbar, copyright);
